...
function updateTaskList() {
    ...
    for (let i of tasksArray) {
        const isChecked = i.status ? "checked" : ""; // Determina si el checkbox debe estar marcado o no
    ...
    totalCounter.textContent = tasksArray.length.toString(); //Contador de total de tareas listadas

}

updateTaskList(); // Llamado de función para que esté actualizada la lista/array
...
// Función para eliminar tareas con botón
...
// Función para generar IDs únicos y no se repitan
